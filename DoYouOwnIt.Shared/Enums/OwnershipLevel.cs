...
namespace DoYouOwnIt.Shared.Enums
{
     ...
     * 4.) NeedsRepairs - The user owns the product, but it requires additional repairs or patches to function correctly.
    ...
    public enum OwnershipLevel
    {
        ...
        MissingFeatures = 3,
        [Display(Name = "Needs Repairs For Full Functionality", Description = "You own the product. But you might need to do some repairs.", GroupName = "Missing Content")]
        NeedsRepairs = 4,
